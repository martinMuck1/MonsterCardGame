...
REM --------------------------------------------------
echo Bonus) show transaction history
...
echo.
echo.
curl -X POST http://localhost:10001/transactions --header "Content-Type: application/json" --header "Authorization: Basic admin-mtcgToken" -d "{\"recipient\":\"altenhof\", \"amount\":5}"
echo.
curl -X POST http://localhost:10001/transactions/packages --header "Content-Type: application/json" --header "Authorization: Basic altenhof-mtcgToken" -d ""
echo.
curl -X GET http://localhost:10001/transactions --header "Authorization: Basic altenhof-mtcgToken"
